...
def test_user_can_create_comment(author_client, detail_url, news, author, comment_text, form_data):
...
def test_user_cant_edit_comment_of_another_user(admin_client, comment, comment_text, edit_url):
